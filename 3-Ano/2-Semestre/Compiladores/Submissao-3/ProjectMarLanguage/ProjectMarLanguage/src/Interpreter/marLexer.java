...
public class marLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"K_VOID", "K_NUMBER", "K_BOOL", "K_STRING", "K_NIL", "NUMBER", "BOOL", 
			"STRING", "RETURN", "WHILE", "DO", "IF", "THEN", "ELSE", "PRINT", "NOT", 
			"AND", "OR", "ID", "WS", "SL_C", "ML_C", "DOT", "COMMA", "SCOL", "LPAR", 
			"RPAR", "LBRAC", "RBRAC", "ASSIGN", "MUL", "DIV", "ADD", "SUB", "GT", 
			"LT", "GEQ", "LEQ", "EQ", "DIF"
		};
	}
