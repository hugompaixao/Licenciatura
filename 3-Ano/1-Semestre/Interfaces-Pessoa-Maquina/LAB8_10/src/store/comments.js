    ...
    actions: {
        async getComments({commit}) {
			try {
				...
				const response = await fetch(`http://daw.deei.fct.ualg.pt/~a64514/LAB8_10/api/comments.php`)
        ...
        async addComment({commit, rootGetters}, newComment) {
			try {
				...
				const response = await fetch(`http://daw.deei.fct.ualg.pt/~a64514/LAB8_10/api/comments.php?micropost_id=${newComment.post_id}&session_id=${rootGetters['user/getUser'].session_id}`, {
					method: 'POST',
